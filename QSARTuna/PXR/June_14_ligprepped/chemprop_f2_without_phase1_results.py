...
Usage:
    ...
    python /home/spal/dockerimages/QSARTuna/PXR/June_14_ligprepped/chemprop_f2_without_phase1_results.py
"""
...
OUTPUT_PREDS     = HERE / "f2_test_predictions.csv"
KEPT_DESCS_PATH  = HERE / "f2_kept_descriptors.txt"
...
# ══════════════════════════════════════════════════════════════════════════════
print(f"\n{'='*70}")
print("F2 Ensemble results (WITHOUT Phase 1 experimental data in training)")
print(f"{'='*70}")
...
print(f"\nEnsemble prediction summary (F2 — WITHOUT Phase 1 data in training):")
