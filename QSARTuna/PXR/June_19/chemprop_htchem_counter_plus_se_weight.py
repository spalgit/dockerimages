...
Compare with chemprop_htchem_counter_weight.py which uses counter weighting
only (no SE term).

Usage:
    conda activate chemprop
    python /home/spal/dockerimages/QSARTuna/PXR/June_19/chemprop_htchem_counter_plus_se_weight.py
"""
...
CV_RESULTS_PATH = HERE / "htchem_counter_se_cv_results.csv"
ENSEMBLE_DIR    = HERE / "htchem_counter_se_ensemble"
OUTPUT_PREDS    = HERE / "htchem_counter_se_test_predictions.csv"
KEPT_DESCS_PATH = HERE / "htchem_counter_se_kept_descriptors.txt"
...
def compute_se_weights(se_values: np.ndarray) -> np.ndarray:
    ...
    # Normalise so the mean of the filled slots equals 1.0
